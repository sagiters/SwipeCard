...
//    }()
    ...
    fileprivate func setupVisualBlurEffectView() {
        ...
        let visialEffectView = UIVisualEffectView(effect: blurEffect)
        
        view.addSubview(visialEffectView)
        visialEffectView.anchor(top: view.topAnchor, leading: view.leadingAnchor, bottom: view.safeAreaLayoutGuide.topAnchor, trailing: view.trailingAnchor)
    }
